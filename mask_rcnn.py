...
#I didin't import the object_detection_classes_coco
...
weightsPath = os.path.sep.join(['mask-rcnn-coco', "frozen_inference_graph.pb"]) # i did t import the weight because its too high
